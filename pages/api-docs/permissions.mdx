...
## et permission entries of a content
...
## et full access control list of a content
...
## et a permissions entry of a specific user or group
...
## ow can I check why a user cannot access a content?
...
## ow can I check why a user cannot save a content?
...
## heck if I can see the permission settings
