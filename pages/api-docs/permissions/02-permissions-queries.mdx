...
## et all identities connected to a content
...
## ount number of permissions settings per identity
...
## et content with permission settings for a specific identity
...
## et identities related to a permission in a subtree
...
## et contents related to a permission in a container
...
## et list of users allowed to do something
...
## ist of group memberships of a user
