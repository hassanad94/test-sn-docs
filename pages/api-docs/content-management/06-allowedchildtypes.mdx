...
### et child types allowed effectively on a content
...
### et child types allowed on a content
...
### et allowed child types set in the content type definition
...
### pdate list of allowed child types on a content
...
### dd a type to the allowed childtypes
...
### emove a type from the allowed childtypes
