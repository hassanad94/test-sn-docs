...
## et current version of a content
...
## et a specific version of a content
...
## ow to know if a content is locked
...
## et version history of a content
...
&nbsp;
<note>
  You must be allowed to restore previous versions having 'Recall old versions'
  permission allowed on the content.
</note>
