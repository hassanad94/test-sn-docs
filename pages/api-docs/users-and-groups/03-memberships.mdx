...
## et all group memberships (roles) of a user
...
## et the list of groups where the user is directly added as a member
...
## et the list of workspaces where the given user is member
